...
public class DepartmentView extends VerticalSplitPanel implements View,
	...
	public void enter(ViewChangeEvent event) {
		...
		if (event.getParameters() != null && !event.getParameters().isEmpty()) {
			try {
				...
				table.setCurrentPageFirstItemId(person);
	...
	private Person getPersonWithId(Integer id) {
		for(Person person : personContainer.getItemIds()) {
	...
	public void valueChange(ValueChangeEvent event) {
		...
		Page.getCurrent().setUriFragment("!department/" + ((Person) table.getValue()).getId(), false);
	}
